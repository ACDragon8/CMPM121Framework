...
public class ProjectileManager : MonoBehaviour
{
    ...
    public void CreateProjectile(int which, string trajectory, Vector3 where, Vector3 direction, float speed, Action<Hittable, Vector3> onHit, bool pierce = false, bool knockback = false, float lifetime=0.0f)
    {
